...
class _MainRigScreenState extends State<MainRigScreen> {
  // قائمة حفظ الـ Boards (عدد غير محدود)
  ...
  // قيم التحكم في الأمبلفاير والدواسات
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [
          // القسم الرئيسي: الدواسات والأمبلفاير
          Expanded(
            flex: 3,
            child: Column(
              children: [
                // 1. قسم الـ Pedalboard العلوي
                Expanded(
                  flex: 1,
                  child: Container(
          ...
          // القسم الجانبي: دواسات الـ Expression (Volume & Wah)
          Expanded(
            flex: 1,
            child: Container(
              margin: const EdgeInsets.all(8),
